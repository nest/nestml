...
to_nest(input_path="/home/archels/julich/nestml-fork/nestml/models/static_synapse.nestml", target_path="/tmp/nestml-target", suffix="_nestml", logging_level="INFO")
...
post = nest.Create("iaf_psc_delta")
