...
.. code-block:: nestml
   ...
   neuron wb_cond_multisyn: # number of steps in the current refractory phase
       ...
       internals: # refractory time in steps
           AMPAInitialValue real = compute_synapse_constant(AMPA_Tau_1,AMPA_Tau_2,AMPA_g_peak) # refractory time in steps
           NMDAInitialValue real = compute_synapse_constant(NMDA_Tau_1,NMDA_Tau_2,NMDA_g_peak) # refractory time in steps
           GABA_AInitialValue real = compute_synapse_constant(GABA_A_Tau_1,GABA_A_Tau_2,GABA_A_g_peak) # refractory time in steps
           GABA_BInitialValue real = compute_synapse_constant(GABA_B_Tau_1,GABA_B_Tau_2,GABA_B_g_peak) # refractory time in steps
   ...
   function compute_synapse_constant(Tau_1 msTau_2 msg_peak nS) real: # Factor used to account for the missing 1/((1/Tau_2)-(1/Tau_1)) term
...
.. footer::
   ...
   Generated at 2023-03-09 09:13:57.090536