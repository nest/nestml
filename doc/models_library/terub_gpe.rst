...
.. code-block:: nestml
   ...
   neuron terub_gpe: # counts number of ticks during the refractory period
       state: # counts number of ticks during the refractory period
           ...
           gate_r real = 0.0 # gating variable r
           Ca_con real = 0.0 # gating variable r
       equations: # Parameters for Terman Rubin GPe Neuron
           ...
           inline g_phi_h real = 0.05 # Report: 0.1, Terman Rubin 2002: 0.05
           ...
           inline g_epsilon 1/ms = 0.0001 / ms # Report:15,  Terman Rubin 2002: 20.0
           ...
           kernel g_inh = (e / tau_syn_inh) * t * exp(-t / tau_syn_inh) # # alpha function for the g_exc
...
.. footer::
   ...
   Generated at 2023-03-09 09:13:56.885644