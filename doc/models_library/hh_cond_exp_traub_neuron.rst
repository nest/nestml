...
The model source code can be found in the NESTML models repository here: `hh_cond_exp_traub_neuron <https://github.com/nest/nestml/tree/main/models/neurons/hh_cond_exp_traub_neuron.nestml>`_.
