...
The model source code can be found in the NESTML models repository here: `aeif_cond_exp_neuron <https://github.com/nest/nestml/tree/main/models/neurons/aeif_cond_exp_neuron.nestml>`_.
