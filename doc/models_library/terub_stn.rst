...
.. code-block:: nestml
   ...
   neuron terub_stn: # counts number of tick during the refractory period
       state: # counts number of tick during the refractory period
           ...
           gate_r real = 0.0 # gating variable r
           Ca_con real = 0.0 # gating variable r
       equations: # Parameters for Terman Rubin STN Neuron
           ...
           inline phi_h real = 0.75 # Guo 0.5 Terman02 0.2
           inline phi_n real = 0.75 # Guo 0.5 Terman02 0.2
...
.. footer::
   ...
   Generated at 2023-03-09 09:13:56.964416