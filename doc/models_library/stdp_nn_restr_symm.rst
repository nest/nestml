...
The model source code can be found in the NESTML models repository here: `stdp_nn_restr_symm <https://github.com/nest/nestml/tree/master/models/synapses/stdp_nn_restr_symm_synapse.nestml>`_.
