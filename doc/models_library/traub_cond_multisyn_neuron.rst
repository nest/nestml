...
The model source code can be found in the NESTML models repository here: `traub_cond_multisyn_neuron <https://github.com/nest/nestml/tree/main/models/neurons/traub_cond_multisyn_neuron.nestml>`_.
