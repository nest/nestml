Running on the EBRAINS Lab
--------------------------

NESTML is a part of the EBRAINS Software Distribution (ESD; https://gitlab.ebrains.eu/ri/tech-hub/platform/esd). It allows you to run NESTML (as well as NEST Simulator) from inside your browser, without any local software installation required!

To access the EBRAINS Lab, you need an EBRAINS account. For information about obtaining one, please see https://ebrains.eu/sign-up.
