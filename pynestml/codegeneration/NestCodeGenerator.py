...
class NestCodeGenerator(object):
    ...
    def setupStandardNamespace(self, _neuron=None):
        ...
        namespace['trace'] = NestCodeGenerator.print_template_origin
        return namespace
    ...
    @classmethod
    def print_template_origin(cls, context):
        """
        Used inside the template to print the template as used to generate content.
        :param context: a context object
        :return: str
        """
        # print origin only if the dev mode is on
        if False:#FrontendConfiguration.is_dev():
            return '/* generated by %s */' % context.name
        else:
            return ''
