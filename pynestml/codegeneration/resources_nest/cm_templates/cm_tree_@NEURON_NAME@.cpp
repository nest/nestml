 ...
 *
 */
#include "cm_tree_cm_default_nestml.h"


nest::CompartmentCmDefaultNestml::CompartmentCmDefaultNestml( const long compartment_index, const long parent_index )
  : xx_( 0.0 )
  , yy_( 0.0 )
  ...
  , n_passed( 0 )
{
  ...
  compartment_currents = CompartmentCmDefaultNestmlCurrents();
}
nest::CompartmentCmDefaultNestml::CompartmentCmDefaultNestml( const long compartment_index,
  ...
  , n_passed( 0 )
{
  ...
  compartment_currents = CompartmentCmDefaultNestmlCurrents( compartment_params );
}

void
nest::CompartmentCmDefaultNestml::calibrate()
{
...
std::map< Name, double* >
nest::CompartmentCmDefaultNestml::get_recordables()
{
...
void
nest::CompartmentCmDefaultNestml::construct_matrix_element( const long lag )
{
...
nest::CompTreeCmDefaultNestml::CompTreeCmDefaultNestml()
  : root_( -1, -1 )
  , size_( 0 )
{
...
{
  CompartmentCmDefaultNestml* compartment = new CompartmentCmDefaultNestml( size_, parent_index );
  add_compartment( compartment, parent_index );
}

void
nest::CompTreeCmDefaultNestml::add_compartment( const long parent_index, const DictionaryDatum& compartment_params )
{
  CompartmentCmDefaultNestml* compartment = new CompartmentCmDefaultNestml( size_, parent_index, compartment_params );
  add_compartment( compartment, parent_index );
}

void
nest::CompTreeCmDefaultNestml::add_compartment( CompartmentCmDefaultNestml* compartment, const long parent_index )
{
  size_++;
  ...
  {
    /**
     * we do not raise an UnknownCompartmentCmDefaultNestml exception from within
     * get_compartment(), because we want to print a more informative
     * exception message
     */
    CompartmentCmDefaultNestml* parent = get_compartment( parent_index, get_root(), 0 );
    if ( parent == nullptr )
    {
      std::string msg = "does not exist in tree, but was specified as a parent compartment";
      throw UnknownCompartmentCmDefaultNestml( parent_index, msg );
    }
  ...
  else
  {
    ...
    if ( root_.comp_index >= 0 )
    {
      ...
      throw UnknownCompartmentCmDefaultNestml( root_.comp_index, msg );
    }
    root_ = *compartment;
  }
 ...
 */
nest::CompartmentCmDefaultNestml*
nest::CompTreeCmDefaultNestml::get_compartment( const long compartment_index ) const
{
  return get_compartment( compartment_index, get_root(), 1 );
}

nest::CompartmentCmDefaultNestml*
nest::CompTreeCmDefaultNestml::get_compartment( const long compartment_index, CompartmentCmDefaultNestml* compartment, const long raise_flag ) const
{
  CompartmentCmDefaultNestml* r_compartment = nullptr;
  ...
  if ( ( not r_compartment ) && raise_flag )
  {
    ...
    throw UnknownCompartmentCmDefaultNestml( compartment_index, msg );
  }
 ...
 * function before CompTreeCmDefaultNestml::init_pointers() is called will result in a segmentation
 * fault
 */
nest::CompartmentCmDefaultNestml*
nest::CompTreeCmDefaultNestml::get_compartment_opt( const long compartment_idx ) const
{
 ...
 */
void
nest::CompTreeCmDefaultNestml::init_pointers()
{
  set_parents();
  set_compartments();
  set_leafs();
 ...
 */
void
nest::CompTreeCmDefaultNestml::set_parents()
{
  for ( auto compartment_idx_it = compartment_indices_.begin(); compartment_idx_it != compartment_indices_.end();
        ++compartment_idx_it )
  {
    CompartmentCmDefaultNestml* comp_ptr = get_compartment( *compartment_idx_it );
    // will be nullptr if root
    CompartmentCmDefaultNestml* parent_ptr = get_compartment( comp_ptr->p_index, &root_, 0 );
 ...
 */
void
nest::CompTreeCmDefaultNestml::set_compartments()
{
  compartments_.clear();
 ...
 */
void
nest::CompTreeCmDefaultNestml::set_leafs()
{
  leafs_.clear();
 ...
 */
void
nest::CompTreeCmDefaultNestml::set_syn_buffers( std::vector< RingBuffer >& syn_buffers )
{
  for ( auto compartment_it = compartments_.begin(); compartment_it != compartments_.end(); ++compartment_it )
  {
 ...
 */
std::map< Name, double* >
nest::CompTreeCmDefaultNestml::get_recordables()
{
 ...
 */
void
nest::CompTreeCmDefaultNestml::calibrate()
{
  if ( root_.comp_index < 0 )
  {
    std::string msg = "does not exist in tree, meaning that no compartments have been added";
    throw UnknownCompartmentCmDefaultNestml( 0, msg );
  }
 ...
 */
std::vector< double >
nest::CompTreeCmDefaultNestml::get_voltage() const
{
 ...
 */
double
nest::CompTreeCmDefaultNestml::get_compartment_voltage( const long compartment_index )
{
 ...
 */
void
nest::CompTreeCmDefaultNestml::construct_matrix( const long lag )
{
  for ( auto compartment_it = compartments_.begin(); compartment_it != compartments_.end(); ++compartment_it )
  {
 ...
 */
void
nest::CompTreeCmDefaultNestml::solve_matrix()
{
  std::vector< CompartmentCmDefaultNestml* >::iterator leaf_it = leafs_.begin();
...
void
nest::CompTreeCmDefaultNestml::solve_matrix_downsweep( CompartmentCmDefaultNestml* compartment, std::vector< CompartmentCmDefaultNestml* >::iterator leaf_it )
{
  ...
  {
    CompartmentCmDefaultNestml* parent = compartment->parent;
...
void
nest::CompTreeCmDefaultNestml::solve_matrix_upsweep( CompartmentCmDefaultNestml* compartment, double vv )
{
 ...
 */
void
nest::CompTreeCmDefaultNestml::print_tree() const
{
  ...
  {
    CompartmentCmDefaultNestml* compartment = compartments_[ ii ];
    std::cout << "    CompartmentCmDefaultNestml " << compartment->comp_index << ": ";
