...
#ifndef CM_{cm_unique_suffix | upper }}_H
#define CM_{cm_unique_suffix | upper }}_H
...
``cm_main_cm_default_nestml`` is an implementation of a compartmental model. The structure of the
...
.. code-block:: Python
  ...
  cm =  nest.Create('cm_main_cm_default_nestml')
...
CompartmentCmDefaultNestml voltages can be recorded. To do so, create a multimeter in the
...
class cm_main_cm_default_nestml : public ArchivingNode
{

public:
  cm_main_cm_default_nestml();
  cm_main_cm_default_nestml( const cm_main_cm_default_nestml& );
...
private:
  ...
  CompTreeCmDefaultNestml c_tree_;
  ...
  friend class DataAccessFunctor< cm_main_cm_default_nestml >;
  friend class DynamicRecordablesMap< cm_main_cm_default_nestml >;
  friend class DynamicUniversalDataLogger< cm_main_cm_default_nestml >;
  ...
  */
  ...
  DynamicRecordablesMap< cm_main_cm_default_nestml > recordablesMap_;
  //! Logger for all analog data
  DynamicUniversalDataLogger< cm_main_cm_default_nestml > logger_;
...
inline port
nest::cm_main_cm_default_nestml::send_test_event( Node& target, rport receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
...
inline port
cm_main_cm_default_nestml::handles_test_event( SpikeEvent&, rport receptor_type )
{
...
inline port
cm_main_cm_default_nestml::handles_test_event( CurrentEvent&, rport receptor_type )
{
...
inline port
cm_main_cm_default_nestml::handles_test_event( DataLoggingRequest& dlr, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
