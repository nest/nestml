...
#ifndef CM_TREE_CMDEFAULTNESTML_H
#define CM_TREE_CMDEFAULTNESTML_H
...
class CompartmentCmDefaultNestml
{
private:
...
public:
  ...
  CompartmentCmDefaultNestml* parent;
  std::vector< CompartmentCmDefaultNestml > children;
  // vector for synapses
  CompartmentCmDefaultNestmlCurrents compartment_currents;
  ...
  CompartmentCmDefaultNestml( const long compartment_index, const long parent_index );
  CompartmentCmDefaultNestml( const long compartment_index, const long parent_index, const DictionaryDatum& compartment_params );
...
*/
inline void
nest::CompartmentCmDefaultNestml::gather_input( const std::pair< double, double >& in )
{
  xx_ += in.first;
  yy_ += in.second;
}
inline std::pair< double, double >
nest::CompartmentCmDefaultNestml::io()
{
...
inline double
nest::CompartmentCmDefaultNestml::calc_v( const double v_in )
{
...
class CompTreeCmDefaultNestml
{
private:
  /*
  structural data containers for the compartment model
  */
  mutable CompartmentCmDefaultNestml root_;
  std::vector< long > compartment_indices_;
  std::vector< CompartmentCmDefaultNestml* > compartments_;
  std::vector< CompartmentCmDefaultNestml* > leafs_;

  long size_ = 0;

  // recursion functions for matrix inversion
  void solve_matrix_downsweep( CompartmentCmDefaultNestml* compartment_ptr, std::vector< CompartmentCmDefaultNestml* >::iterator leaf_it );
  void solve_matrix_upsweep( CompartmentCmDefaultNestml* compartment, double vv );
...
public:
  ...
  void add_compartment( CompartmentCmDefaultNestml* compartment, const long parent_index );
  void calibrate();
  void init_pointers();
  ...
  CompartmentCmDefaultNestml* get_compartment( const long compartment_index ) const;
  CompartmentCmDefaultNestml* get_compartment( const long compartment_index, CompartmentCmDefaultNestml* compartment, const long raise_flag ) const;
  CompartmentCmDefaultNestml* get_compartment_opt( const long compartment_indx ) const;
  CompartmentCmDefaultNestml*
  get_root() const
  {
    return &root_;
...
#endif /* #ifndef CM_TREE_CMDEFAULTNESTML_H */