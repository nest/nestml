...
class GSLNamePrinter(CppNamePrinter):
    r"""
    ...
    def print_name_reference(self, variable: ASTVariable, prefix: str = '') -> str:
        ...
        variable_name = self.print_cpp_name(variable.get_name())
...
e();'''
    ...
    def name(self, symbol: VariableSymbol) -> str:
        ...
        if symbol.is_state() and not symbol.is_inline_expression:
            return "ode_state[State_::" + self.print_cpp_name(symbol.get_symbol_name()) + "]"
