# -*- coding: utf-8 -*-
#
# nest_cpp_variable_getter_printer.py
#
...
class NESTCppVariableGetterPrinter(CppVariablePrinter):
    r"""
    This is a printer for ASTVariables in C++ syntax. Nodes will be printed as calls to their getter methods.
    """
