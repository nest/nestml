...
class SolverInput(object):
    ...
    def SolverInputComplete(self, _equationsBlock=None):
        ...
        self.__ode = self.printEquation(workingCopy.get_ode_equations()[0])
        self.__functions = list()
        for func in workingCopy.get_ode_functions():
            self.__functions.append(self.printFunction(func))

        self.__shapes = list()
        for shape in workingCopy.get_ode_shapes():
    ...
    def printEquation(self, _equation=None):
        ...
        return _equation.get_lhs().get_complete_name() + ' = ' + self.__printer.print_expression(_equation.get_rhs())
    ...
    def printShape(self, _shape=None):
        ...
        return _shape.get_variable().get_complete_name() + ' = ' \
               + self.__printer.print_expression(_shape.get_expression())
    ...
    def printFunction(self, _function=None):
        ...
        return _function.get_variable_name() + ' = ' + self.__printer.print_expression(_function.get_expression())
