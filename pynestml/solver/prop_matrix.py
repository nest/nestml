...
from pynestml.solver.shapes import ShapeFunction, ShapeODE
...
class PropagatorCalculator(object):
        ...
        for shape in shapes:
            ...
            if isinstance(shape, ShapeFunction):
                ...
                if shape.order == 1:
                    ...
                    solutionpq = -shape.derivative_factors[1] / 2 + sqrt(
                        shape.derivative_factors[1] ** 2 / 4 + shape.derivative_factors[0])
    ...
    def prop_matrix_to_prop_step(prop_matrices, const_input, step_const, shapes, ode_var_str):
        ...
        ode_var_update_instructions = [
            ode_var_str + " = " + str(PropagatorCalculator.constant_input(step_const, ode_var_str))]
