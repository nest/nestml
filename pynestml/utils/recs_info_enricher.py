...
class RecsInfoEnricher(MechsInfoEnricher):
    ...
    def restore_order_internals(cls, neuron: ASTModel, cm_syns_info: dict):
        ...
        for index, declaration in enumerate(
                RecsInfoEnricherVisitor.declarations_ordered):
    ...
    def get_analytic_helper_variable_declarations(cls, single_synapse_info):
        ...
        for variable_name in variable_names:
            if variable_name not in RecsInfoEnricherVisitor.internal_variable_name_to_variable:
                continue
            variable = RecsInfoEnricherVisitor.internal_variable_name_to_variable[variable_name]
            expression = RecsInfoEnricherVisitor.variables_to_internal_declarations[variable]
...
class RecsInfoEnricherVisitor(ASTVisitor):
    ...
    def __init__(self):
        super(RecsInfoEnricherVisitor, self).__init__()
    ...
    def visit_inline_expression(self, node):
        ...
        RecsInfoEnricherVisitor.inline_name_to_transformed_inline[inline_name] = node
    ...
    def visit_declaration(self, node):
        ...
        if self.inside_internals_block:
            ...
            RecsInfoEnricherVisitor.variables_to_internal_declarations[variable] = expression
            RecsInfoEnricherVisitor.internal_variable_name_to_variable[variable.get_name(
            )] = variable
