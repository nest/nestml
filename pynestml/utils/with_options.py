...
class WithOptions:
    r"""This class allows options (indexed by strings) to be set and retrieved. A set of default options may be
    supplied by overriding the `_default_options` member in the inheriting class. """
    ...
    def set_options(self, options: Mapping[str, Any]) -> Mapping[str, Any]:
        r"""Set options. "Eats off" any options that it knows how to set, and returns the rest as "unhandled"
        options. """
        unhandled_options = {}
