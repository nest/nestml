...
class ASTSynapseInformationCollector(object):
    ...
    @classmethod
    def log_unresolved_function_dependency(cls, synapse, function_call, context: str):
        ...
        Logger.log_message(node=synapse, code=code, message=message, error_position=function_call.get_source_position(),
                           log_level=LoggingLevel.ERROR)

    @classmethod
    def log_unresolved_variable_dependency(cls, synapse, variable, context: str):
        ...
        Logger.log_message(node=synapse, code=code, message=message, error_position=variable.get_source_position(),
                           log_level=LoggingLevel.ERROR)
                ...
                if len(search_functions) > 0:
                    ...
                    if not function_found:
                        cls.log_unresolved_function_dependency(
                            neuron,
                            function_call,
                            "compartmental synapse information for \"" + mechanism_name + "\"")
