...
class ASTNodeFactory:
    ...
    @classmethod
    def create_ast_input_port(cls, name, size_parameter, data_type, signal_type, source_position):
        # type:(str,str,(None|ASTDataType),PortSignalType,ASTSourceLocation) -> ASTInputPort
