...
class ASTNodeFactory(object):
    ...
    def create_ast_input_qualifier(cls, is_inhibitory=False, is_excitatory=False, is_post=False, source_position=None):
        ...
        return ASTInputQualifier(is_inhibitory, is_excitatory, is_post, source_position)
    ...
    def create_ast_neuron(cls, name, body, source_position, artifact_name):
        # type: (str,ASTNeuronBody,ASTSourceLocation,str) -> ASTNeuron
    ...
    @classmethod
    def create_ast_variable(cls, name, differential_order=0, source_position=None, is_homogeneous=False):
        # type: (str,int,ASTSourceLocation) -> ASTVariable
        return ASTVariable(name, differential_order, source_position, is_homogeneous)
