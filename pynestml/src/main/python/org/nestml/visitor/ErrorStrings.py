...
class ErrorStrings(object):
    ...
    def code(cls,_origin = None):
        ...
        from pynestml.src.main.python.org.nestml.visitor.expression_visitor.ComparisonOperatorVisitor import ComparisonOperatorVisitor
    ...
    @classmethod
    def messageAddSubTypeMismatch(cls, _origin=None, _lhsTypeText=None, _rhsTypeText=None, _resultTypeText=None, _sourcePosition=None):
        """
