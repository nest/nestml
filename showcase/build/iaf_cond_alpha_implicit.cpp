...
* Recordables map
* ---------------------------------------------------------------- */
nest::RecordablesMap<iaf_cond_alpha_implicit>
    iaf_cond_alpha_implicit::recordablesMap_;

namespace nest {
// Override the create() method with one call to RecordablesMap::insert_()
// for each quantity to be recorded.
template <> void RecordablesMap<iaf_cond_alpha_implicit>::create() {
  // use standard names whereever you can for consistency!
  /* generated by template org.nest.nestml.neuron.function.RecordCallback*/

  insert_("V_m", &iaf_cond_alpha_implicit::get_V_m);

  /* generated by template org.nest.nestml.neuron.function.RecordCallback*/

  insert_("g_in", &iaf_cond_alpha_implicit::get_g_in);

  /* generated by template org.nest.nestml.neuron.function.RecordCallback*/

  insert_("g_ex", &iaf_cond_alpha_implicit::get_g_ex);

  /* generated by template org.nest.nestml.neuron.function.RecordCallback*/

  insert_("g_in'", &iaf_cond_alpha_implicit::get___D_g_in);

  /* generated by template org.nest.nestml.neuron.function.RecordCallback*/

  insert_("g_ex'", &iaf_cond_alpha_implicit::get___D_g_ex);

  /* generated by template org.nest.nestml.neuron.function.RecordCallback*/

  // ignores the PSConInit_E with the domain type double

  /* generated by template org.nest.nestml.neuron.function.RecordCallback*/

  // ignores the PSConInit_I with the domain type double
...
* ---------------------------------------------------------------- */
iaf_cond_alpha_implicit::Parameters_::Parameters_() {
  V_th = 0;
  V_reset = 0;
  t_ref = 0;
  g_L = 0;
...
iaf_cond_alpha_implicit::State_::State_() {
  y[State_::V_m] = 0;
  y[State_::g_in] = 0;
  y[State_::g_ex] = 0;
  y[State_::__D_g_in] = 0;
...
iaf_cond_alpha_implicit::Buffers_::Buffers_(iaf_cond_alpha_implicit &n)
    : logger_(n), __s(0), __c(0), __e(0) {}

iaf_cond_alpha_implicit::Buffers_::Buffers_(const Buffers_ &,
                                            iaf_cond_alpha_implicit &n)
    : logger_(n), __s(0), __c(0), __e(0)
...
iaf_cond_alpha_implicit::iaf_cond_alpha_implicit()
...
iaf_cond_alpha_implicit::iaf_cond_alpha_implicit(
    const iaf_cond_alpha_implicit &n)
...
void iaf_cond_alpha_implicit::init_state_(
    const Node &proto) { // TODO inner components

  const iaf_cond_alpha_implicit &pr = downcast<iaf_cond_alpha_implicit>(proto);
  S_ = pr.S_;
}
...
extern "C" inline int iaf_cond_alpha_implicit_dynamics(double, const double y[],
                                                       double f[],
                                                       void *pnode) {
  typedef iaf_cond_alpha_implicit::State_ State_;
  // get access to node so we can almost work as in a member function
  assert(pnode);
  const iaf_cond_alpha_implicit &node =
      *(reinterpret_cast<iaf_cond_alpha_implicit *>(pnode));
...
void iaf_cond_alpha_implicit::init_buffers_() {
  ...
  B_.__sys.function = iaf_cond_alpha_implicit_dynamics;
...
void iaf_cond_alpha_implicit::calibrate() {
  B_.logger_.init();

  /* generated by template org.nest.nestml.neuron.function.Calibrate*/

  V_.PSConInit_E = 1.0 * numerics::e / P_.tau_syn_ex;

  /* generated by template org.nest.nestml.neuron.function.Calibrate*/

  V_.PSConInit_I = 1.0 * numerics::e / P_.tau_syn_in;
 ...
 */
void iaf_cond_alpha_implicit::update(nest::Time const &origin, const long from,
                                     const long to) {
  double t = 0;
  ...
  for (long lag = from; lag < to; ++lag) {
    ...
    /* generated by template org.nest.spl.SmallStatement*/
    /* generated by template org.nest.spl.small_statement.Assignment*/
    S_.y[State_::__D_g_ex] += B_.spikeExc_last_value_ * V_.PSConInit_E;

    /* generated by template org.nest.spl.Statement*/
    //
    /* generated by template org.nest.spl.SmallStatement*/
    /* generated by template org.nest.spl.small_statement.Assignment*/
    S_.y[State_::__D_g_in] += B_.spikeInh_last_value_ * V_.PSConInit_I;
...
void iaf_cond_alpha_implicit::handle(nest::DataLoggingRequest &e) {
  B_.logger_.handle(e);
}

void iaf_cond_alpha_implicit::handle(nest::SpikeEvent &e) {
...
void iaf_cond_alpha_implicit::handle(nest::CurrentEvent &e) {
  assert(e.get_delay() > 0);
