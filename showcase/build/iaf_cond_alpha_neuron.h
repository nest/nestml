...
*
*/
#ifndef IAF_COND_ALPHA_NEURON
#define IAF_COND_ALPHA_NEURON
#include "config.h"
...
/* BeginDocumentation
Name: iaf_cond_alpha_neuron.

//
Name: iaf_cond_alpha_neuron - Simple conductance based leaky integrate-and-fire
neuron
                       model.
...
Empty
*/
class iaf_cond_alpha_neuron : public nest::Archiving_Node {
public:
  /**
  ...
  */
  iaf_cond_alpha_neuron(const iaf_cond_alpha_neuron &);
...
private:
  ...
  friend class nest::RecordablesMap<iaf_cond_alpha_neuron>;
  friend class nest::UniversalDataLogger<iaf_cond_alpha_neuron>;
  ...
  */
  struct Variables_ {
    ...
    double g_in__D_PSCInitialValue; //

    /* generated by template org.nest.nestml.neuron.function.MemberDeclaration*/

    double g_ex__D_PSCInitialValue; //
  };
   ...
   * that
    ...
    */
  struct Buffers_ {
    Buffers_(iaf_cond_alpha_neuron &);
    Buffers_(const Buffers_ &, iaf_cond_alpha_neuron &);

    /** Logger for all analog data */
    nest::UniversalDataLogger<iaf_cond_alpha_neuron> logger_;
  ...
  inline double get_g_in__D_PSCInitialValue() const {
    return V_.g_in__D_PSCInitialValue;
  }

  inline void set_g_in__D_PSCInitialValue(const double __v) {
    V_.g_in__D_PSCInitialValue = __v;
  }

  /* generated by template
   * org.nest.nestml.neuron.function.MemberVariableGetterSetter*/

  inline double get_g_ex__D_PSCInitialValue() const {
    return V_.g_ex__D_PSCInitialValue;
  }

  inline void set_g_ex__D_PSCInitialValue(const double __v) {
    V_.g_ex__D_PSCInitialValue = __v;
  }
  ...
  */
  ...
  static nest::RecordablesMap<iaf_cond_alpha_neuron> recordablesMap_;

  friend int iaf_cond_alpha_neuron_dynamics(double, const double y[],
                                            double f[], void *pnode);
  /** @} */
}; /* neuron iaf_cond_alpha_neuron */

inline nest::port iaf_cond_alpha_neuron::send_test_event(
...
inline nest::port
iaf_cond_alpha_neuron::handles_test_event(nest::SpikeEvent &,
...
inline nest::port
iaf_cond_alpha_neuron::handles_test_event(nest::CurrentEvent &,
                                          nest::port receptor_type) {
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
iaf_cond_alpha_neuron::handles_test_event(nest::DataLoggingRequest &dlr,
                                          nest::port receptor_type) {
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_cond_alpha_neuron::get_status(DictionaryDatum &__d) const {
...
inline void iaf_cond_alpha_neuron::set_status(const DictionaryDatum &__d) {
  /* generated by template
...
#endif /* #ifndef IAF_COND_ALPHA_NEURON */
#endif /* HAVE GSL */
