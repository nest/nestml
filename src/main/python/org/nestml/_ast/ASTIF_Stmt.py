...
"""
import ASTIF_Clause
import ASTELSE_Clause
import ASTELIF_Clause
...
class ASTIF_Stmt:
    ...
    def __init__(self, _ifClause: ASTIF_Clause = None, _elifClauses: list(ASTELIF_Clause) = list(),
    ...
    @classmethod
    def makeASTIF_Stmt(cls, _ifClause: ASTIF_Clause = None, _elifClauses: list(ASTELIF_Clause) = list(),
                       _elseClause: ASTELSE_Clause = None):
        """
    ...
    def getElifClauses(self) -> list(ASTELIF_Clause):
        """
