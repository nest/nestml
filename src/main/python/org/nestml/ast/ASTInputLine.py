...
TODO header
"""
from src.main.python.org.nestml.ast.ASTInputType import ASTInputType
...
class ASTInputLine:
    ...
    def __init__(self, _name: str = None, _sizeParameter: str = None, _inputTypes: list = list(),
    ...
    @classmethod
    def makeASTInputLine(cls, _name: str = None, _sizeParameter: str = None, _inputTypes: list = list(),
                         _isSpike: bool = False, _isCurrent: bool = False):
        """
