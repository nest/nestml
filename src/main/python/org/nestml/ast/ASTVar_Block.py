...
class ASTVar_Block:
    ...
    def __init__(self, _isState: bool = False, _isParameters: bool = False, _isInternals: bool = False,
                 _declarations: list = list()):
        """
    ...
    @classmethod
    def makeASTVar_Block(cls, _isState: bool = False, _isParameters: bool = False, _isInternals: bool = False,
                         _declarations: list = list()):
        """
