 ...
 * @author plotnikov
 */
public class SPLPrettyPrinter extends PrettyPrinterBase implements NESTMLVisitor {
  private final ExpressionsPrettyPrinter expressionsPrinter;
  private ASTNESTMLNode root;

  public SPLPrettyPrinter(final ExpressionsPrettyPrinter expressionsPrettyPrinter) {
    this.expressionsPrinter = expressionsPrettyPrinter;
  }

  public void print(final ASTNESTMLNode node) {
    root = node;
    node.accept(this);
  }
