 ...
 */
public class ExpressionTypeVisitor implements NESTMLVisitor {
  private NESTMLVisitor realThis = this;
  ...
  public void handle(org.nest.nestml._ast.ASTExpr node) {
    traverse(node);
  ...
  @Override
  public NESTMLVisitor getRealThis() {
    return realThis;
  }

  @Override
  public void setRealThis(NESTMLVisitor realThis) {
    this.realThis = realThis;
  }

  public void traverse(org.nest.nestml._ast.ASTExpr node) {
