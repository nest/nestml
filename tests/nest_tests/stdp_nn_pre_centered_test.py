...
class NestSTDPNNSynapseTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        to_nest(input_path=["models/iaf_psc_exp.nestml", "models/stdp_nn_pre_centered.nestml"],
                ...
                codegen_opts={"neuron_parent_class": "StructuralPlasticityNode",
                              ...
                              "neuron_synapse_dyads": [["iaf_psc_exp", "stdp_nn_pre_centered"]]})
 ...
 188., 194., 202., 245., 249., 289., 454.])
    ...
    def run_synapse_test(self, neuron_model_name,
        ...
        if TEST_PLOTS:
            ...
            if sim_mdl:
             ax2.plot(nest.GetStatus(mm, "events")[0]["times"], nest.GetStatus(mm, "events")[0]["post_trace__for_stdp_nn_pre_centered_nestml"], label="nestml post tr")
