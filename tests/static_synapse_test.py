...
@pytest.mark.skipif('nest' not in sys.modules,
	                reason="Skipping test because pynest module is not available!")
def test_static_synapse_nest_integration():
...
if __name__ == "__main__":
	test_static_synapse_nest_integration()
