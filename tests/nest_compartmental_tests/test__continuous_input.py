...
class TestContinuousInput:
    ...
    def test_continuous_input(self):
        ...
        assert 19.9 < res['i_tot_input0'][data_array_index] < 20.1, ("the current (left) is not close enough to expected (right). (" + str(res['i_tot_input0'][data_array_index]) + " != " + "20.0 +- 0.1" + ")")
